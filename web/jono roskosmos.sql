...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 15, 2020 at 12:34 PM
...
INSERT INTO `ataskaita` (`inv_nr`, `data`, `aprasas`, `id`) VALUES
('RK123SS', '2020-12-15 01:19:06', 'Statusas: Naudojama -> Gedimas', 1),
('RK1234SS', '2020-12-15 07:54:48', 'Statusas: Naudojama -> Gedimas', 22),
('ljkhkjhb13211jkhbjh', '2020-12-15 07:56:21', 'Statusas: Naudojama -> Gedimas', 23),
('aaaaaa', '2020-12-15 08:09:40', 'Inentoriaus elementas buvo ištrintas', 24),
('aabb', '2020-12-15 08:11:34', 'Inentoriaus elementas buvo pridėtas', 25),
('jhljglgo guyygug', '2020-12-15 08:22:15', 'Pavadinimmas: Leg Presas3 -> Leg Presas \n Statusas: Naudojama -> Sandelyje \n Patikros data:  -> ', 26),
('aabb', '2020-12-15 08:51:43', 'Statusas: Naudojama -> Gedimas', 27),
('ljkhkjhb13211jkhbjh', '2020-12-15 08:51:50', 'Pavadinimmas: Svoris 10KG -> Svoris 10KG \n Statusas: Gedimas -> Naudojama \n Patikros data:  -> ', 28),
('RK1234SS', '2020-12-15 08:51:57', 'Pavadinimmas: štanga -> štanga \n Statusas: Gedimas -> Naudojama \n Patikros data:  -> ', 29),
('RK654123SS', '2020-12-15 08:52:03', 'Pavadinimmas: Lygiagretės -> Lygiagretės \n Statusas: Gedimas -> Naudojama \n Patikros data:  -> ', 30),
('RK1234123SS', '2020-12-15 08:52:12', 'Pavadinimmas: Svoris 25KG -> Svoris 25KG \n Statusas: Gedimas -> Naudojama \n Patikros data:  -> ', 31),
('aabb', '2020-12-15 08:52:22', 'Pavadinimmas: aaaaabbbb -> aaaaabbbb \n Statusas: Gedimas -> Remontas \n Patikros data:  -> ', 32),
('aabb', '2020-12-15 08:53:09', 'Pavadinimmas: aaaaabbbb -> aaaaabbbb \n Statusas: Remontas -> Remonttuojama \n Patikros data:  -> ', 33),
('aabb', '2020-12-15 08:53:31', 'Pavadinimmas: aaaaabbbb -> aaaaabbbb \n Statusas: Remonttuojama -> Remontuojama \n Patikros data:  -> ', 34),
('ljkhkjhb13211jkhbjh', '2020-12-15 09:12:05', 'Statusas: Naudojama -> Gedimas', 35),
('aabb', '2020-12-15 11:05:19', 'Inentoriaus elementas buvo ištrintas', 36);
...
INSERT INTO `inventorius` (`pavadinimas`, `statusas`, `isigijimo_data`, `patikros_data`, `inv_nr`, `fk_sales_id`, `inventoriaus_id`) VALUES
('Svoris 10KG', 'Gedimas', '2020-12-19', '2020-12-12', 'ljkhkjhb13211jkhbjh', 1, 1),
('štanga', 'Naudojama', '2020-12-09', '2020-12-03', 'RK1234SS', 1, 2),
('Leg Presas', 'Sandelyje', '2020-07-31', '2020-12-11', 'jhljglgo guyygug', 1, 9),
('Bėgimo takelis', 'Gedimas', '2020-01-02', '2020-12-14', 'RK6654321SS', 1, 18),
('Svoris 25KG', 'Naudojama', '2020-12-27', '2020-12-13', 'RK1234123SS', 1, 22),
('Hantelis 15KG', 'Gedimas', '2020-12-03', '2020-12-13', 'RK12234SS', 1, 23),
('Lygiagretės', 'Naudojama', '2020-09-18', '2020-12-13', 'RK654123SS', 1, 24);
...
CREATE TABLE `preke` (
  ...
  `fk_sandelio_id` int(11) NOT NULL,
  `id` int(11) NOT NULL,
  `foto` varchar(255) DEFAULT 'https://archive.org/download/no-photo-available/no-photo-available.png',
  `kiekis_sandelyje` int(11) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `preke` (`pavadinimas`, `aprasymas`, `kaina`, `fk_sandelio_id`, `id`, `foto`, `kiekis_sandelyje`) VALUES
('Apgaule', 'HAHAHHAHAHHA', 110.99, 1, 1, 'https://lt3.pigugroup.eu/colours/352/400/86/35240086/maisto-papildai-pure-gf1-protein-vaniles-skonio_xbig.jpg', 12),
('Optimum nutrition WHEY	', 'Geriausi papildai Amerikos rinkoje	', 28, 1, 2, 'https://biofitus.lt/1190-home_default/spirulina.jpg', 14),
('Optimum malnutrition WHEY	', 'Geriausi papildai Afrikos rinkoje	', 15.29, 1, 3, 'https://www.dogpunk.lt/out/pictures/generated/product/1/800_800_95/papildai-sunims-istvermei.jpg', 3),
('Nullable trition WHEY	', 'TuRi GaL KaZkO?', 44.44, 1, 4, 'https://garbane.lt/9909-large_default/maisto-papildai-zarnynui-ir-lieknejimui-spanguoliu-skonio-colonwell-cranberry-400g.jpg', 5),
('SUPER energy MEGA', 'Blogiausi papildai azijojej', 123, 1, 5, 'https://www.papildupasaulis.lt/image/cache/data/Optimum-Nutrition/goldas__proteinas-625x625_0.jpg', 12),
('BALTI miltai', 'Super vitaminu kiekis', 14.89, 1, 6, 'https://daiktadezes.lt/images/9e42a85fa04dd4b476422a01a2c2e412.jpg', 6),
('TiKrAi NaTuRaLu', 'Ruki bazuki po situ', 37.49, 1, 7, 'https://shcc.ufl.edu/files/2011/11/anabolic_steroids.jpg', 3),
('Nullable trition WHEY	', 'Geriausi papildai Amerikos rinkoje	', 17, 1, 8, 'https://www.sveikataisgamtos.lt/117-tm_thickbox_default/vita-squares-maisto-papildai-vaikams.jpg', 5);
...
INSERT INTO `sandelys` (`id`, `laisva_vieta`) VALUES
(1, 222224753);
...
CREATE TABLE `saskaita` (
  `kaina_be_pvm` double NOT NULL,
  `kaina_su_pvm` double NOT NULL,
  `id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO