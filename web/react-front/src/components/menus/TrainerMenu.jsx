            ...
            <div className="collapse navbar-collapse">
                <ul className="navbar-nav mr-auto">
                    <li className="nav-item">
                        <Link to="/programos" className="navbar-logo">
                            <span className="nav-link" >Programos <span className="sr-only">(current)</span></span>
                        </Link>
                    </li>
                    <li className="nav-item">
                        <Link to="/klientu-klaendorius" className="navbar-logo">
                            <span className="nav-link" >Klientų kalendorius <span className="sr-only">(current)</span></span>
                        </Link>
                    </li>
                    <li className="nav-item">
                        <Link to="/klientai" className="navbar-logo">
                            <span className="nav-link" >Klientai <span className="sr-only">(current)</span></span>
                        </Link>
                    </li>
                    <li className="nav-item">
                    ...
                    <li className="nav-item">
                        <Link to="/" className="navbar-logo">
                            <span className="nav-link" >Registruoti gedimą <span className="sr-only">(current)</span></span>
                        </Link>
                    </li>
                </ul>
            </div>
                    ...
                    <li className="nav-item dropdown">
                        ...
                        <div className="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            <Link to="/trainer-profile">
                                <span className="dropdown-item dropint" >Trenerio profilis</span>
                            </Link>
