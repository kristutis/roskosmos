...
export default function TrainerProfile() {
    ...
    function applyChanges() {
        ...
        if (desc!==''){
            trainer.aprasymas=desc
        }
        if (price!==''){
            trainer.kaina= parseFloat(price)
        }
        ...
        const updatedTrainer = {
            user: updatedUser,
            fk_trenerio_id: updatedUser.id, 
            kaina: trainer.kaina, 
            aprasymas: trainer.aprasymas,
            moto: trainer.moto,
            vertinimas: trainer.vertinimas
        }
        fetch(window.backend+"/trainers/"+user.id,
            {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json'
        ...
        console.log(JSON.stringify(updatedTrainer))
    }
    ...
    useEffect(() => {
        ...
        if (uid!=='') {
            ...
            fetch(window.backend+"/trainers/"+uid,
                    {
                        method: 'GET',
                        headers: {
                            'Content-Type': 'application/json'
                    ...
                    <div className="col-md-8 second-profile-div">
                        <div className="row">
                            <div className="col-md-6">
                                ...
                                <br></br>
                                <h5>Kaina: </h5>
                                <input type="number" className="w-75 form-control" defaultValue={trainer.kaina} onChange={e => setPrice(e.target.value)}/>               
                                <br></br>
                            </div>   
                            <div className="col-md-6">
                                <br></br>
                            ...
                            <div className="col-md-12">
                                <h5>Moto</h5>
                                <input type="text" className="w-175 form-control" defaultValue={trainer.moto} onChange={e => setMoto(e.target.value)}/> 
                                <br></br>
                                <h5>Aprašymas</h5>
                                <textarea rows="4" className="w-175 form-control" defaultValue={trainer.aprasymas} onChange={e => setDesc(e.target.value)}/> 
                            </div>                                          
                        </div> 
                        <br></br><br></br>
                        <hr/>
